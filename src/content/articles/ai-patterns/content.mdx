...
By splitting AI responses among multiple bots, rather than just one, it's easier for the user to mentally divide the AI output into different mental "buckets". Because it is analagous to human team-work, this is intuitive for users to grasp.

Users can also address individual bots by name, to ask for further assistance on a specific topic or aspect covered by just that bot.
